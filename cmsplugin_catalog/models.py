...
class CatalogPlugin(CMSPlugin):
    ...
    panel_header_link = models.BooleanField(_('Panel header link to catalog page'), blank=True)
    panel_footer_text = models.CharField(_('Panel footer text'), max_length=500, null=True, blank=True)
    panel_footer_link = models.BooleanField(_('Panel footer link to catalog page'), blank=True)
    panel_after_content = models.BooleanField(_('After the panel body has a placeholder'), blank=True)
    display_panel_header = models.BooleanField(_('Display panel header'), blank=True, default=True)
    ...
    display_date = models.BooleanField(_('Show page date in line'), blank=True)
...
class CatalogExtension(PageExtension):
    is_catalog = models.BooleanField(_('This page is a catalog'))
